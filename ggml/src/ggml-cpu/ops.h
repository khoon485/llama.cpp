...
void ggml_compute_forward_dpo_loss(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_lora_matmul(const struct ggml_compute_params * params, struct ggml_tensor * dst);
